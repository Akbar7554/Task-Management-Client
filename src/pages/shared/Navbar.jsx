    ...
    <nav className="fixed z-30 backdrop-blur-sm  w-full  border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a className="flex items-center space-x-3 rtl:space-x-reverse">
          ...
          <span className="self-center text-gray-200 text-lg md:text-2xl font-semibold whitespace-nowrap dark:text-white">
            Management
          </span>
        </a>
        ...
        {user?.email ? (
          <div className="dropdown ml-2 dropdown-end text-white">
        ...
        >
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <NavLink to="/" className="block py-2 px-3 md:text-lg text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#00CDAC] md:p-0 md:dark:hover:text-[#00CDAC] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
                Home
              </NavLink>
            </li>
            {user?<li>
